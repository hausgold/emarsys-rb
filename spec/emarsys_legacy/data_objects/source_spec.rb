...
describe EmarsysLegacy::Source do
  describe ".collection" do
    it "requests all sources" do
      stub_get("source") { EmarsysLegacy::Source.collection }.should have_been_requested.once
    end
  end
  ...
  describe ".create" do
    it "requests source creation with parameters" do
      ...
      EmarsysLegacy::Source.create('test_source')
  ...
  describe ".delete" do
    it "requests source deletion" do
      ...
      EmarsysLegacy::Source.destroy(123)
      stub.should have_been_requested.once
    end
  end
end
