...
describe EmarsysLegacy::Event do
  describe ".collection" do
    it "requests all events" do
      stub_get("event") { EmarsysLegacy::Event.collection }.should have_been_requested.once
    end
  end
  ...
  describe ".trigger" do
    it "requests event trigger with parameters" do
      ...
      EmarsysLegacy::Event.trigger(123, 3, 'jane.doe@example.com')
    ...
    it "requests event trigger with additional data parameters" do
      ...
      EmarsysLegacy::Event.trigger(123, 3, 'jane.doe@example.com', {'global' => {'my_placeholder' => 'Something'}})
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".trigger_multiple" do
    it "requests event trigger with parameters" do
      ...
      EmarsysLegacy::Event.trigger_multiple(123,3,[{'external_id' => 'jane.doe@example.com'}])
      stub.should have_been_requested.once
    end
  end
end
