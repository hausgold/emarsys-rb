...
describe EmarsysLegacy::Contact do
  describe ".create" do
    it "requests contact creation with parameters" do
      ...
      EmarsysLegacy::Contact.create(3, "john.doe@example.com", stub_params)
  ...
  describe ".emarsys_id" do
    it "requests emarsys_id of a contact" do
      ...
      EmarsysLegacy::Contact.emarsys_id(3, 'jane.doe@example.com')
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".update" do
    it "requests contact update with parameters" do
      ...
      EmarsysLegacy::Contact.update(3, 'jane.doe@example.com', stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".create_batch" do
    it "requests contact batch creation with parameters" do
      ...
      EmarsysLegacy::Contact.create_batch(3, stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".update_batch" do
    it "requests contact batch update with parameters" do
      ...
      EmarsysLegacy::Contact.update_batch(3, stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".contact_history" do
    it "requests contact histories" do
      ...
      EmarsysLegacy::Contact.contact_history(stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".search" do
    it "requests contact data based on search params" do
      ...
      EmarsysLegacy::Contact.search('3', ['jane.doe@example.com'])
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".export_registrations" do
    it "requests contact data export based on parameters" do
      ...
      EmarsysLegacy::Contact.export_registrations(stub_params)
      stub.should have_been_requested.once
    end
  end
