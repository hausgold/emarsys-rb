...
describe EmarsysLegacy::Email do
  describe ".collection" do
    it "requests all emails" do
      stub_get('email') { EmarsysLegacy::Email.collection }.should have_been_requested.once
    end

    it "requests all emails to the given status parameter" do
      stub_get('email/?status=3') { EmarsysLegacy::Email.collection({:status => 3}) }.should have_been_requested.once
    end

    it "requests all emails to the given contactlist parameter" do
      stub_get('email/?contactlist=123') { EmarsysLegacy::Email.collection({:contactlist => 123}) }.should have_been_requested.once
    end

    it "requests all emails - even with combined parameters" do
      stub_get('email/?status=3&contactlist=123') { EmarsysLegacy::Email.collection({:status => 3, :contactlist => 123}) }.should have_been_requested.once
    end
  end

  describe ".resource" do
    it "requests a single email" do
      stub_get('email/123') { EmarsysLegacy::Email.resource(123) }.should have_been_requested.once
    end
  end
  ...
  describe ".create" do
    ...
    it "requests email creation with parameters" do
      ...
      EmarsysLegacy::Email.create(stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".launch" do
    it "requests an email launch" do
      ...
      EmarsysLegacy::Email.launch(123)
      stub.should have_been_requested.once
    end
    ...
    it "requests an email launch with parameters" do
      ...
      EmarsysLegacy::Email.launch(123, stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".preview" do
    it "requests an email preview" do
      ...
      EmarsysLegacy::Email.preview(123, 'html')
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".send_test_mail" do
    it "requests an email test sending with custom recipient list" do
      ...
      EmarsysLegacy::Email.send_test_mail(123, stub_params)
      stub.should have_been_requested.once
    end
  end
  ...
  describe ".response_summary" do
    it "requests a single email" do
      stub_get('email/123/responsesummary') { EmarsysLegacy::Email.response_summary(123) }.should have_been_requested.once
    end
  end
