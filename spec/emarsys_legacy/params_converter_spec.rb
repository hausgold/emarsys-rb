...
describe EmarsysLegacy::ParamsConverter do
  let(:converter) { EmarsysLegacy::ParamsConverter.new({}) }
  ...
  before :each do
    ...
    stub_const("EmarsysLegacy::FieldMapping::ATTRIBUTES", attributes)
  end

  describe 'with attributes' do
    it 'sets params attribute on initialize' do
      params = {1 => 'Jane', 2 => 'Doe'}
      params_converter = EmarsysLegacy::ParamsConverter.new(params)
