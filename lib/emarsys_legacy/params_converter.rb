  ...
  class ParamsConverter
    ...
    def convert_to_ids
      ...
      params.each do |key, value|
        matching_attributes = EmarsysLegacy::FieldMapping::ATTRIBUTES.find{|elem| elem[:identifier] == key.to_s}
    ...
    def convert_to_identifiers
      new_hash = {}
      params.each do |key, value|
        matching_attributes = EmarsysLegacy::FieldMapping::ATTRIBUTES.find{|elem| elem[:id] == key.to_i && key.to_i != 0}
