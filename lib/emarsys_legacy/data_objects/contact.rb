module EmarsysLegacy
  ...
  class Contact < DataObject
    class << self
      ...
      # @example
      #   EmarsysLegacy::Contact.create('app_id', 23, {:firstname => "Jon", :lastname => "Doe"})
      #   EmarsysLegacy::Contact.create('3', 'john.doe@example.com', {'1' => "Jon", '2' => "Doe"})
      ...
      # @example
      #   EmarsysLegacy::Contact.emarsys_id('email', 'john.dow@example.com')
      #   EmarsysLegacy::Contact.emarsys_id(1, 'John')
      ...
      # @return [Hash] internal id of the contact
      # @example
      #   EmarsysLegacy::Contact.update('app_id', 23, {:firstname => "Jon", :lastname => "Doe"})
      #   EmarsysLegacy::Contact.update('3', 'john.doe@example.com', {'1' => "Jon", '2' => "Doe"})
      ...
      # @example
      #   EmarsysLegacy::Contact.create_batch(
      ...
      # @param params [Hash] Contact information of each new contact
      # @example
      #   EmarsysLegacy::Contact.update_batch(
      #     'email', {:app_id => 1, :firstname => "Jon", :lastname => "Doe"},
      #              {:app_id => 2, :firstname => "Jane", :lastname => "Doe"}
      #   )
      #
      ...
      # @example
      #   EmarsysLegacy::Contact.contact_history([1,2,3]
      ...
      # @return [Hash] result data
      # @example
      #   EmarsysLegacy::Contact.search('3', ['john.doe@example.com'], [1,2,3]
      #
      ...
      # @return [Hash] result data
      # @example
      #   EmarsysLegacy::Contact.export_registrations(distribution_method: 'local', time_range: ["2013-01-01","2013-12-31"], contact_fields: [1,2,3])
      ...
      def transform_key_id(key_id)
        matching_attributes = EmarsysLegacy::FieldMapping::ATTRIBUTES.find{|elem| elem[:identifier] == key_id.to_s}
