module EmarsysLegacy
  ...
  class Email < DataObject
    class << self
      ...
      # @example
      #   EmarsysLegacy::Email.collection
      #   EmarsysLegacy::Email.collection(:status => 3)
      #   EmarsysLegacy::Email.collection(:contactlist => 5)
      ...
      # @example
      #   EmarsysLegacy::Email.resource(1)
      def resource(id)
        get "email/#{id}", {}
      end
      ...
      # @return [Hash] Result data
      # @example
      #   EmarsysLegacy::Email.response_summary(1)
      ...
      # @return [Hash] Result data
      # @example
      #   EmarsysLegacy::Email.send_test_mail(1, {:recipientlist => 'john.doe@example.com;jane.doe@example.com'})
      ...
      # @return [Hash] Result data
      # @example
      #   EmarsysLegacy::Email.delivery_status(1)
