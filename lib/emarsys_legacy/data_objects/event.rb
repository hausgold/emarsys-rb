module EmarsysLegacy
  ...
  class Event < DataObject
    ...
    class << self
      ...
      # @example
      #   EmarsysLegacy::Event.collection
      def collection
        get 'event', {}
      end
      ...
      # @example
      #   EmarsysLegacy::Event.trigger(2, 3, 'test@example.com')
      #   EmarsysLegacy::Event.trigger(2, 'user_id', 57687, {:global => {:name => "Special Name"}})
      ...
      # @return [Hash] Result data
      # @example
      #   EmarsysLegacy::Event.trigger_multiple(2, 3, [{:external_id => "test@example.com"},{:external_id => "test2@example.com", :data => {:name => "Special Name"}}])
