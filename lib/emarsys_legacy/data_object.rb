...
module EmarsysLegacy
  class DataObject
    class << self
      ...
      #
      # @param method_name [String] The path, relative to EmarsysLegacy.api_endpoint
      ...
      # Encode params like EmarsysLegacy does
    ...
    def request(http_verb, method_name, params)
      response = EmarsysLegacy::Request.new(http_verb, method_name, params).send_request
      #hashiefy(response)
    end
